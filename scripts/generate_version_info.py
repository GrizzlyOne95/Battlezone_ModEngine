...
FILE_DESCRIPTION = "Battlezone Mod Engine"
INTERNAL_NAME = "BZModEngine"
ORIGINAL_FILENAME = "BZModEngine.exe"
...
def main() -> None:
    ...
    parser.add_argument("--version", required=True, help="Release version, for example 1.0.10 or v1.0.10")
